 ...
 * @param {(boolean|string|Array<!string>)} filter The filter to match the
 * 		value against.
 ...
 * @param {...*} _args Any additional variable to dump as log output.
 * @private
 */
ttapp.debug._log = function(debuglevel, module, _args) {
